...
def augment_list(aug_type):  # 16 oeprations and their ranges
...
# augment_dict = {fn.__name__: (fn, v1, v2) for fn, v1, v2 in augment_list(C.get()['aug'])}
...
def policy_decoder(augment, num_policy, num_op, aug_type):
    op_list = augment_list(aug_type)
    policies = []
...
class Augmentation(object):
    def __init__(self, policies, aug_type):
        self.policies = policies
        self.augmentations = {fn.__name__: (fn, v1, v2) for fn, v1, v2 in augment_list(C.get()['aug'])}
